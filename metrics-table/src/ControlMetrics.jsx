...
function ControlMetrics() {
  const [data, setData] = useState([
    ...
    {
      id: 5,
      text: "Τάση εξόδου του κυκλώματος φόρτισης (σε V DC)",
      input1: "",
      input2: "",
      input3: "",
      input4: "",
    ...
    {
      id: 8,
      text: "Είναι σβηστά τα LED της λάμπας όταν το φωτιστικό φορτίζει;",
      input1: "",
      input2: "",
    },
    {
    ...
    {
      id: 14,
      text: "<b>Κατανάλωση από τη μπαταρία στην εφεδρική λειτουργία (σε mA) <br><u> -> Για μπαταρίες Ni-Cd, Ni-Mh, LiFePo4:</u> <br> Imax < (60min:0.4xC5A, 90min:0.51xC5A, 180min:0.25xC5A, 480min:0.1xC5A) <br> <u> -> Για μπαταρία Μολύβδου (Pb):</u> <br> Imax < (60min:0.4xC20A, 90min:0.34xxC20A, 180min:0.17xxC20A) </b>",
      limit1: "",
      limit2: "",
      limit3: "",
    },
    {
      id: 15,
      text: "Κατανάλωση από τη μπαταρία (ονομαστιή τάση μπαταρίας) στην εφεδρική λειτουργία (σε mA) όταν η τάση του δικτύου είναι 0,6 x μέγιστη τάση λειτουργίας (σε V AC). Η κατανάλωση πρέπει να είναι περίπου ίδια με την κατανάλωση που αναφερεται στην παραπάνω παραγραφο.",
      input1: "",
      input2: "",
      input3: "",
    },
    ...
    {
      id: 17,
      text: "V AC =90V. Φωτιστικό μπαίνει στην αποκοπή. Ξυπνάει σε 1' με VAC=220V",
      input1: "",
    },
    {
      id: 18,
    ...
    {
      id: 24,
      text: "Δοκιμή ενδεικτικών LED και τις λειτουργίες τους και συγκριση με την εκτυπωση στο πλαστικό",
      input1: "",
    },
    {
      id: 25,
    ...
    {
      id: 26,
      text: "Βραχυκύκλωμα φορτιστή (στο φισ μπαταρίας) για 1 λεπτό σε τάση 1.06 x ονομαστική τάση δικτύου και μέτρηση θερμοκρασίας  στο κύκλωμα φόρτισης",
      input1: "",
      input2: "",
    },
    {
    ...
    {
      id: 29,
      text: "Έλεγχος αντοχής σε θερμοθάλαμο (στα όρια της θερμοκρασίας λειτουργίας).(Δες το τέλος του εγγράφου για ναλυτικά βήματα)",
      input1: "",
    },
    ...
    {
      id: 34,
      text: "Έλεγχος ομαλής έναυσης λεντοσειράς",
      text1: "",
      text2: "",
      text3: "",
      text4: "",
    ...
    {
      id: 35,
      text: "Έλεγχος σφάλματος λεντοσειράς σε τεστ, με και χωρίς L1",
      input1: "",
      input2: "",
    },
    {
