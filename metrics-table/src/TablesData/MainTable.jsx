const MainTable = [
  ...
  {
    id: 9,
    text: "Δοκιμή φόρτισης με άδεια μπαταρία {middleInput}",
    input1: "",
    input2: "",
    input3: "",
    input4: "",
  ...
  {
    id: 18,
    text: "Τάση τροφοδοσίας μικρολεγκτή (αν υπάρχει) με χρήση wireless module. Όριο: Μέχρι 200mV κάτω από την ονομαστική τάση {middleInput}",
  },
